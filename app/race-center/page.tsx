    ...
    <>
      ...
      <main className="mob-pad-page" style={{ position: 'relative', zIndex: 1, maxWidth: '1400px', margin: '0 auto', padding: '28px 32px 60px' }}>
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: '14px', marginTop: '8px', maxWidth: '500px', lineHeight: 1.7 }}>
            Interactive dashboards for serious F1 Fantasy managers. Live data, lineup optimisers and strategy simulators.
          </p>
        </div>
        ...
        <div className="mob-1col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '32px' }}>
          {[
            ...
            <div key={tool.name} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '28px' }}>
              ...
              <p style={{ fontSize: '13px', color: 'var(--muted)', lineHeight: 1.6 }}>{tool.description}</p>
              <div style={{ marginTop: '16px', height: '2px', background: 'var(--surface2)', borderRadius: '1px', overflow: 'hidden' }}>
                <div style={{ width: '33%', height: '100%', background: '#E8002D', opacity: 0.4 }} />
              </div>
              <p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '10px', color: 'var(--muted2)', marginTop: '6px' }}>In development</p>
            </div>
          ))}
        </div>
