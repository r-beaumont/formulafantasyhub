    ...
    <>
      ...
      <main className="mob-pad-page" style={{ position: 'relative', zIndex: 1, maxWidth: '1400px', margin: '0 auto', padding: '28px 32px 60px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: '13px', marginTop: '8px' }}>Expert F1 Fantasy analysis from Rob Beaumont — official columnist for formula1.com</p>
        </div>
          ...
          <div className="mob-1col" style={{
            ...
            <div className="mob-featured-thumb" style={{ height: '340px', background: featured.thumbnail, position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ position: 'absolute', top: '16px', left: '16px', zIndex: 3 }}>
                <span style={{ fontSize: '10px', fontWeight: 700, padding: '4px 10px', borderRadius: '20px', background: '#E8002D', color: 'var(--text)', textTransform: 'uppercase' as const, letterSpacing: '1px' }}>Latest</span>
              </div>
            </div>
            {/* Right — content */}
            <div style={{ padding: '40px', display: 'flex', flexDirection: 'column' as const, justifyContent: 'center' }}>
              <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '16px' }}>
                <span style={{ fontSize: '10px', fontWeight: 700, padding: '3px 10px', borderRadius: '20px', background: categoryColors[featured.category]?.bg || 'rgba(255,255,255,0.1)', color: categoryColors[featured.category]?.color || 'var(--text)', textTransform: 'uppercase' as const, letterSpacing: '0.5px' }}>{featured.tag}</span>
        ...
        <div style={{ height: '160px', background: article.thumbnail, position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          {article.premium && (
            <div style={{ position: 'absolute', top: '10px', right: '10px', zIndex: 2 }}>
              <span style={{ fontSize: '9px', fontWeight: 700, padding: '3px 8px', borderRadius: '4px', background: '#E8002D', color: 'var(--text)', textTransform: 'uppercase' as const }}>Premium</span>
            </div>
          )}
