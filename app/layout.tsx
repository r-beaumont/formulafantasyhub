...
export const metadata: Metadata = {
  ...
  description: 'Formula 1 data, analysis and strategy — all in one place. Race results, championship standings and expert F1 Fantasy analysis from Rob Beaumont.',
