...
export const metadata: Metadata = {
  ...
  description: 'F1 Fantasy strategy tools for the 2026 season. Driver prices, chip timing analysis, scoring breakdowns and expert transfer tips from Rob Beaumont.',
  alternates: { canonical: 'https://formulahub.live/f1-fantasy' },
  openGraph: {
    title: 'F1 Fantasy Strategy 2026 — Tips, Chip Guide & Scoring',
    description: 'F1 Fantasy strategy tools for the 2026 season. Driver prices, chip timing and expert tips from Rob Beaumont.',
