...
export default function CircuitMap({ round, mode = 'draw', showCaption = true }: { round: number; mode?: 'draw' | 'loop'; showCaption?: boolean }) {
  ...
  return (
    <div>
      ...
      ` }} />
      <div style={{
        position: 'relative', borderRadius: showCaption ? '12px 12px 0 0' : '12px', overflow: 'hidden',
