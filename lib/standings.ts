...
const _driverMeta: Omit<DriverStanding, 'pos' | 'points' | 'wins'>[] = [
  { id: 'russell',    name: 'George Russell',    shortName: 'RUS', team: 'Mercedes',        teamColor: '#27F4D2', flag: 'gb' },
  { id: 'antonelli',  name: 'Kimi Antonelli',    shortName: 'ANT', team: 'Mercedes',        teamColor: '#27F4D2', flag: 'it' },
  { id: 'leclerc',    name: 'Charles Leclerc',   shortName: 'LEC', team: 'Ferrari',         teamColor: '#E8002D', flag: 'mc' },
  { id: 'hamilton',   name: 'Lewis Hamilton',    shortName: 'HAM', team: 'Ferrari',         teamColor: '#E8002D', flag: 'gb' },
  { id: 'bearman',    name: 'Oliver Bearman',    shortName: 'BEA', team: 'Haas',            teamColor: '#B6BABD', flag: 'gb' },
  { id: 'norris',     name: 'Lando Norris',      shortName: 'NOR', team: 'McLaren',         teamColor: '#FF8000', flag: 'gb' },
  { id: 'gasly',      name: 'Pierre Gasly',      shortName: 'GAS', team: 'Alpine',          teamColor: '#FF69B4', flag: 'fr' },
  { id: 'verstappen', name: 'Max Verstappen',    shortName: 'VER', team: 'Red Bull Racing', teamColor: '#3671C6', flag: 'nl' },
  { id: 'lawson',     name: 'Liam Lawson',       shortName: 'LAW', team: 'Racing Bulls',    teamColor: '#6692FF', flag: 'nz' },
...
const _conMeta: Omit<ConstructorStanding, 'pos' | 'points' | 'wins'>[] = [
  { name: 'Mercedes',        color: '#27F4D2', flag: 'de', price: 34.5 },
  { name: 'Ferrari',         color: '#E8002D', flag: 'it', price: 23.9 },
  { name: 'Haas',            color: '#B6BABD', flag: 'us', price: 8.6  },
  { name: 'McLaren',         color: '#FF8000', flag: 'gb', price: 22.0 },
  { name: 'Alpine',          color: '#FF69B4', flag: 'fr', price: 13.5 },
  { name: 'Racing Bulls',    color: '#6692FF', flag: 'it', price: 12.0 },
  { name: 'Red Bull Racing', color: '#3671C6', flag: 'at', price: 18.0 },
  { name: 'Williams',        color: '#64C4FF', flag: 'gb', price: 11.5 },
  { name: 'Audi',            color: '#C0C0C0', flag: 'de', price: 9.5  },
  { name: 'Aston Martin',    color: '#358C75', flag: 'gb', price: 10.5 },
  { name: 'Cadillac',        color: '#CC0000', flag: 'us', price: 8.0  },
]
