// Circuit overview, track-speed, description and pitwall data — single source
// of truth for the Race Hub, moved out of RaceHubClient.tsx so it can also be
// read (as small server-computed values) by the Home page hero.

  export const circuitOverviewData: Record<number, any> = {
  ...
  export const TRACK_SPEEDS: Record<number, string> = {
  ...
  export const CIRCUIT_DESCRIPTIONS: Record<number, string> = {
  ...
  export const pitwallData: Record<number, {
    downforce: string
