...
export const RACE_WEEKENDS: Record<number, RaceWeekend> = {
  ...
  2: {
    ...
    sprintQualifying: [
      ...
      { position: 1,  name: 'George Russell',    team: 'Mercedes',        team_colour: '#27F4D2', q3: '1:31.520', q2: null, q1: null,          time: '1:31.520' },
      { position: 2,  name: 'Kimi Antonelli',    team: 'Mercedes',        team_colour: '#27F4D2', q3: '1:31.809', q2: null, q1: null,          time: '1:31.809' },
      { position: 3,  name: 'Lando Norris',      team: 'McLaren',         team_colour: '#FF8000', q3: '1:32.141', q2: null, q1: null,          time: '1:32.141' },
      { position: 4,  name: 'Lewis Hamilton',    team: 'Ferrari',         team_colour: '#E8002D', q3: '1:32.161', q2: null, q1: null,          time: '1:32.161' },
      { position: 5,  name: 'Oscar Piastri',     team: 'McLaren',         team_colour: '#FF8000', q3: '1:32.224', q2: null, q1: null,          time: '1:32.224' },
      { position: 6,  name: 'Charles Leclerc',   team: 'Ferrari',         team_colour: '#E8002D', q3: '1:32.528', q2: null, q1: null,          time: '1:32.528' },
      { position: 7,  name: 'Pierre Gasly',      team: 'Alpine',          team_colour: '#FF69B4', q3: '1:32.888', q2: null, q1: null,          time: '1:32.888' },
      { position: 8,  name: 'Max Verstappen',    team: 'Red Bull Racing', team_colour: '#3671C6', q3: '1:33.254', q2: null, q1: null,          time: '1:33.254' },
      { position: 9,  name: 'Oliver Bearman',    team: 'Haas',            team_colour: '#B6BABD', q3: '1:33.409', q2: null, q1: null,          time: '1:33.409' },
      { position: 10, name: 'Isack Hadjar',      team: 'Red Bull Racing', team_colour: '#3671C6', q3: '1:33.723', q2: null, q1: null,          time: '1:33.723' },
      // --- SQ2 eliminated (P11–16): segment times unavailable ---
      { position: 11, name: 'Nico Hülkenberg',   team: 'Audi',            team_colour: '#C0C0C0', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 12, name: 'Esteban Ocon',      team: 'Haas',            team_colour: '#B6BABD', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 13, name: 'Liam Lawson',       team: 'Racing Bulls',    team_colour: '#6692FF', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 14, name: 'Gabriel Bortoleto', team: 'Audi',            team_colour: '#C0C0C0', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 15, name: 'Arvid Lindblad',    team: 'Racing Bulls',    team_colour: '#6692FF', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 16, name: 'Franco Colapinto',  team: 'Alpine',          team_colour: '#FF69B4', q3: null, q2: null, q1: null,               time: '—'        },
      // --- SQ1 eliminated (P17–22): segment times unavailable; Pérez did not set a time ---
      { position: 17, name: 'Carlos Sainz',      team: 'Williams',        team_colour: '#64C4FF', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 18, name: 'Alex Albon',        team: 'Williams',        team_colour: '#64C4FF', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 19, name: 'Fernando Alonso',   team: 'Aston Martin',    team_colour: '#358C75', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 20, name: 'Lance Stroll',      team: 'Aston Martin',    team_colour: '#358C75', q3: null, q2: null, q1: null,               time: '—'        },
      { position: 21, name: 'Valtteri Bottas',   team: 'Cadillac',        team_colour: '#CC0000', q3: null, q2: null, q1: null,               time: '—'        },
    ...
    qualifying: [
      ...
      { position: 1,  name: 'Kimi Antonelli',    team: 'Mercedes',        team_colour: '#27F4D2', q3: '1:32.064', q2: null, q1: null,           time: '1:32.064' },
      { position: 2,  name: 'George Russell',    team: 'Mercedes',        team_colour: '#27F4D2', q3: '1:32.286', q2: null, q1: null,           time: '1:32.286' },
      { position: 3,  name: 'Lewis Hamilton',    team: 'Ferrari',         team_colour: '#E8002D', q3: '1:32.415', q2: null, q1: null,           time: '1:32.415' },
      { position: 4,  name: 'Charles Leclerc',   team: 'Ferrari',         team_colour: '#E8002D', q3: '1:32.428', q2: null, q1: null,           time: '1:32.428' },
      { position: 5,  name: 'Oscar Piastri',     team: 'McLaren',         team_colour: '#FF8000', q3: '1:32.550', q2: null, q1: null,           time: '1:32.550' },
      { position: 6,  name: 'Lando Norris',      team: 'McLaren',         team_colour: '#FF8000', q3: '1:32.608', q2: null, q1: null,           time: '1:32.608' },
      { position: 7,  name: 'Pierre Gasly',      team: 'Alpine',          team_colour: '#FF69B4', q3: '1:32.873', q2: null, q1: null,           time: '1:32.873' },
      { position: 8,  name: 'Max Verstappen',    team: 'Red Bull Racing', team_colour: '#3671C6', q3: '1:33.002', q2: null, q1: null,           time: '1:33.002' },
      { position: 9,  name: 'Isack Hadjar',      team: 'Red Bull Racing', team_colour: '#3671C6', q3: '1:33.121', q2: null, q1: null,           time: '1:33.121' },
      { position: 10, name: 'Oliver Bearman',    team: 'Haas',            team_colour: '#B6BABD', q3: '1:33.292', q2: null, q1: null,           time: '1:33.292' },
      // --- Q2 eliminated (P11–16): segment times unavailable ---
      { position: 11, name: 'Nico Hülkenberg',   team: 'Audi',            team_colour: '#C0C0C0', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 12, name: 'Franco Colapinto',  team: 'Alpine',          team_colour: '#FF69B4', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 13, name: 'Esteban Ocon',      team: 'Haas',            team_colour: '#B6BABD', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 14, name: 'Liam Lawson',       team: 'Racing Bulls',    team_colour: '#6692FF', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 15, name: 'Arvid Lindblad',    team: 'Racing Bulls',    team_colour: '#6692FF', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 16, name: 'Gabriel Bortoleto', team: 'Audi',            team_colour: '#C0C0C0', q3: null, q2: null, q1: null,                time: '—'        },
      // --- Q1 eliminated (P17–22): segment times unavailable ---
      { position: 17, name: 'Carlos Sainz',      team: 'Williams',        team_colour: '#64C4FF', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 18, name: 'Alex Albon',        team: 'Williams',        team_colour: '#64C4FF', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 19, name: 'Fernando Alonso',   team: 'Aston Martin',    team_colour: '#358C75', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 20, name: 'Valtteri Bottas',   team: 'Cadillac',        team_colour: '#CC0000', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 21, name: 'Lance Stroll',      team: 'Aston Martin',    team_colour: '#358C75', q3: null, q2: null, q1: null,                time: '—'        },
      { position: 22, name: 'Sergio Pérez',      team: 'Cadillac',        team_colour: '#CC0000', q3: null, q2: null, q1: null,                time: '—'        },
    ],
  },
